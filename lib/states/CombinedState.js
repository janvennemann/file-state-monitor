...
/**
 * Combined state that uses last modified, file size and SHA-1 hash to detect
 * file changes
 */
export default class CombinedState extends BaseFileState {
  ...
  constructor(fileInfo) {
    ...
    if (Reflect.ownKeys(fileInfo).length === 1) {
